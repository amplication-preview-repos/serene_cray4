...
@InputType()
class PoliceStationCreateNestedManyWithoutProvincesInput {
...
export { PoliceStationCreateNestedManyWithoutProvincesInput as PoliceStationCreateNestedManyWithoutProvincesInput };
