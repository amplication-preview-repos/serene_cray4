...
@InputType()
class OutletSurveyCreateNestedManyWithoutSurveysInput {
...
export { OutletSurveyCreateNestedManyWithoutSurveysInput as OutletSurveyCreateNestedManyWithoutSurveysInput };
